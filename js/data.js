  ...
  deep_learning: [
    {
      ...
      blocks: [
        { id: 0, code: 'import numpy as np' },
        { id: 1, code: 'def sigmoid(x):' },
        { id: 2, code: '    return 1 / (1 + np.exp(-x))' },
        { id: 3, code: 'def forward_pass(X, W1, b1, W2, b2):' },
        { id: 4, code: '    Z1 = np.dot(X, W1) + b1' },
        { id: 5, code: '    A1 = sigmoid(Z1)' },
        { id: 6, code: '    Z2 = np.dot(A1, W2) + b2' },
        { id: 7, code: '    A2 = sigmoid(Z2)' },
        { id: 8, code: '    return A2' },
      ],
      correctOrder: [0, 1, 2, 3, 4, 5, 6, 7, 8],
      hints: [
        'まず numpy をインポートし、活性化関数 sigmoid(x) = 1/(1+e^-x) を定義する',
