// ahc_001: 最近傍法で巡回路の初期解を作る ★3 (C++)
// AHC で使うことの多い、貪欲な初期解構築
(window.PROBLEMS_REGISTRY = window.PROBLEMS_REGISTRY || []).push({
  ...
  difficulty: 3,
  language: 'cpp',
  description: '【ヒューリスティック形式とは】\nAtCoder Heuristic Contest（AHC）では、最適解を厳密に求める代わりに、制限時間内にできるだけ良いスコアの解を出します。この問題では、平面上の都市をすべて1度ずつ訪れて出発点に戻る巡回路を作ります。\n\n【問題】\n都市0から出発し、未訪問の都市のうち現在地に最も近い都市を次に選ぶ最近傍法で訪問順を作ってください。最後に都市0へ戻ります。これは最適とは限りませんが、高速に妥当な初期解を作れるため、局所探索や焼きなましの出発点として有用です。',
  inputFormat: {
    params: [
  ...
  explanation: {
    ...
    points: [
      ...
      'AHC では、まずこのような初期解を作り、2-opt や焼きなましで改善する流れがよく使われる',
